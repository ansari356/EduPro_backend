...
urlpatterns = [
    ...
    path("teacher/courses/<uuid:course_id>/enrollments/<uuid:student_id>/",course_views.TeacherCourseEnrollmentsView.as_view(),name="teacher-course-enrollments-student"),
     path('teacher/students/<uuid:student_id>/enrollments/',course_views.TeacherCourseEnrollmentsView.as_view(),name='teacher-student-enrollments'),
